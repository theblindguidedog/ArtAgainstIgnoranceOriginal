...
def about(request):
    return render(request, 'AAI_App/about.html', {})

def contact(request):
    return render(request, 'AAI_App/contact.html', {})

def test(request):
    return render(request, 'AAI_App/test.html', {})

def music(request):
    return render(request, 'AAI_App/music.html', {})

def video(request):
    return render(request, 'AAI_App/video.html', {})

def shop(request):
    return render(request, 'AAI_App/shop.html', {})

def shop_details(request):
    return render(request, 'AAI_App/shop_details.html', {})

def shop_details_liamgervaise(request):
    return render(request, 'AAI_App/shop_details_liamgervaise.html', {})

def news(request):
    return render(request, 'AAI_App/news.html', {})
...
def artists(request):
    return render(request, 'AAI_App/artists.html', {})
...
def artist_details_darceygervaise2(request):
    return render(request, 'AAI_App/artist_details_darceygervaise2.html', {})
...
def artist_details_nerdyrodent2(request):
    return render(request, 'AAI_App/artist_details_nerdyrodent2.html', {})
...
def artist_details_blatantblatheist2(request):
    return render(request, 'AAI_App/artist_details_blatantblatheist2.html', {})
